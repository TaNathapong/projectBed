    ...
    linePattern: function(options) {
        var that = this,
            ...
            lineParams = options.isWaved ? {
                points: [0, 2, WAVED_LINE_LENGTH / 4, WAVED_LINE_TOP, WAVED_LINE_LENGTH / 4, WAVED_LINE_TOP, WAVED_LINE_LENGTH / 2, WAVED_LINE_CENTER, 3 * WAVED_LINE_LENGTH / 4, WAVED_LINE_BOTTOM, 3 * WAVED_LINE_LENGTH / 4, WAVED_LINE_BOTTOM, WAVED_LINE_LENGTH, WAVED_LINE_CENTER],
                type: "bezier",
        ...
        elements.push(that.path(that._getPointsWithYOffset(lineParams.points, size / 2), lineParams.type).attr({
        ...
        line.id = id;
        line.size = lineParams.maxSize + 2 * strokeWidth;
        return line
    },
